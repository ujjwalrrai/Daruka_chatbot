...
| Challenge Requirement | Darukaa.Earth |
|---|---|
| Conversational AI | Natural-language environmental interaction |
| Environmental understanding | Site-state extraction |
| Scientific grounding | Research-backed evidence chunks |
| Knowledge system | PostgreSQL + pgvector |
| Causal reasoning | Environmental causal graph |
| Multi-metric reasoning | Connected environmental variables |
| Explainable recommendations | Evidence + causal paths |
| Structured output | Metrics, recommendation, confidence, time horizon |

---

## ⚠️ Deployment Note

Due to the limited time available for the hackathon submission, the application could not be fully deployed.

The repository therefore contains the implementation, frontend, Docker configuration, knowledge base, reasoning engine, scientific evidence corpus, and local setup instructions for review and reproduction.
...
Built for the Environmental AI / Causal Evidence Engine challenge.
